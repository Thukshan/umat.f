      ...
      integer, parameter :: nsdv  = 119 ! changes when accumulated slip SDV is added
     ...
     +    writeflag(maxphasenum)
      ...
      CASE(0) ! Example HCP System
          ...
          ! Elastic Constants taken from (Tromans., 2011)
          E1 = 139.9270E+3; E3 = 163.2326E+3 ! in MPa
          v12 = 0.3455
          v13 = 0.2193        
          G12 = E1/(2.0*(1.0+v12)); G13 = 66937.5     
